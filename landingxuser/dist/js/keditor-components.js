...
!(function (t, o) {
	if ("object" == typeof exports && "object" == typeof module)
		...
		define(["KEditor", "jQuery", "CKEDITOR"], o);
	else {
		var e =
			"object" == typeof exports
				? o(require("KEditor"), require("jQuery"), require("CKEDITOR"))
				: o(t.KEditor, t.jQuery, t.CKEDITOR);
		...
		function (t, o, e) {
			...
			i.a.components.audio = {
				...
				init: function (t, o, e, n) {
					...
					0 === i.find(".audio-wrapper").length &&
						i.wrapInner('<div class="audio-wrapper"></div>');
				},
				...
				showSettingForm: function (t, o, e) {
					...
					a.prop("checked", !!n.attr("autoplay")),
						l.prop("checked", !!n.attr("controls")),
						s.val(i.attr("data-width") || 100);
				},
			};
			e(4);
			var a,
			...
			(i.a.components.form = {
				emptyContent:
					'<p class="text-muted lead text-center"><br />[No form content]<br /><br /></p>',
								...
								if (((e = e.split("-")), t.attr("class")))
									if (t.hasClass("fb-button"))
										...
										var n = t.children("label"),
											...
											a = t.children("div");
										n.addClass("control-label col-sm-".concat(e[0])),
											a.length > 0
												? a.addClass("col-sm-".concat(e[1]))
												: i
														.addClass("form-control")
														.wrap(
															'<div class="col-sm-'.concat(e[1], '"></div>')
														);
									}
							});
				},
				initModal: function (t) {
					var o = this;
					(a = t.initModal("keditor-modal-form"))
						.find(".keditor-modal-title")
						.html("Design form"),
						a.css({ visibility: "hidden", display: "block", opacity: 1 }),
						a
							.find(".keditor-modal-body")
							.append(
						...
						a.find(".btn-save-form").on("click", function (e) {
							...
							n.find(".form-data").html(l.actions.getData("json")),
								o.renderForm(n),
								t.hideModal(a);
						}),
						setTimeout(function () {
				...
				init: function (t, o, e, n) {
					...
					0 === e.find(".form-data").length &&
						i.append(
							'<div class="form-data" style="display: none !important;"></div>'
						),
						0 === l.length &&
							i.append(
								'<form class="form-content">'.concat(
									this.emptyContent,
									"</form>"
								)
							),
				...
				initSettingForm: function (t, o) {
					...
					t.html(
						...
						t.find(".select-enctype").on("change", function () {
							o.getSettingComponent()
								.find(".form-content")
								.attr("enctype", this.value);
						}),
						t.find(".select-layout").on("change", function () {
							var n = o.getSettingComponent(),
								i = n.find(".form-content");
							i.removeClass("form-inline form-horizontal"),
								this.value && i.addClass(this.value),
								e.renderForm(n),
								t
									.find(".select-grid-wrapper")
									.css(
										"display",
										"form-horizontal" === this.value ? "block" : "none"
									);
						}),
						t.find(".select-grid").on("change", function () {
							var t = o.getSettingComponent();
							t.find(".form-content").attr("data-grid", this.value),
								e.renderForm(t);
						});
				},
				showSettingForm: function (t, o, e) {
					var n = o.find(".form-content"),
						i = "";
					n.hasClass("form-inline")
						? (i = "form-inline")
						: n.hasClass("form-horizontal") && (i = "form-horizontal"),
						...
						t
							.find(".select-grid-wrapper")
							.css("display", "form-horizontal" === i ? "block" : "none"),
				...
				(i.a.components.photo = {
					init: function (t, o, e, n) {
						e.children(".keditor-component-content")
							.find("img")
					...
					initSettingForm: function (t, o) {
						...
						// 	return $.ajax({
						// 		url: "https://www.myconnectmind.com/LandingxUser/subirImagen/",
						// 		type: "POST",
						// 		data: formData,
						// 		contentType: false,
						// 		processData: false,
						...
						n.on("click", function (t) {
							...
							i.on("change", function () {
								...
								if (/image/.test(n.type)) {
									var i = new FileReader();
									i.addEventListener("load", function (w) {
										var formData = new FormData();
							...
							t.find("#photo-align").on("change", function () {
								o.getSettingComponent()
									.find(".photo-panel")
									.css("text-align", this.value);
							}),
							t.find("#photo-responsive").on("click", function () {
								o.getSettingComponent()
									.find("img")
									[this.checked ? "addClass" : "removeClass"]("img-responsive");
							}),
						...
						a.on("change", function () {
							...
							n <= 0 && ((n = e.width), (i = e.height), (this.value = n)),
								t.css({ width: n, height: i }),
								l.val(i);
						}),
							l.on("change", function () {
								var t = o.getSettingComponent().find("img"),
									n = +this.value,
									i = Math.round(n * e.ratio);
								n <= 0 && ((i = e.width), (n = e.height), (this.value = n)),
									t.css({ height: n, width: i }),
									a.val(i);
							});
					},
					showSettingForm: function (t, o, e) {
						...
						("right" === u && "center" === u) || (u = "left"),
							p.hasClass("img-rounded")
								? d.val("img-rounded")
								: p.hasClass("img-circle")
								? d.val("img-circle")
								: p.hasClass("img-thumbnail")
								? d.val("img-thumbnail")
								: d.val(""),
							i.val(u),
							...
							r()("<img />")
								.attr("src", p.attr("src"))
								.load(function () {
									(n.ratio = this.width / this.height),
										(n.width = this.width),
			...
			(c.a.disableAutoInline = !0),
					...
					init: function (t, o, e, n) {
						...
						a.prop("contenteditable", !0),
							a.on("input", function (a) {
								"function" == typeof i.onComponentChanged &&
									i.onComponentChanged.call(n, a, e),
									"function" == typeof i.onContainerChanged &&
										i.onContainerChanged.call(n, a, o, t),
									"function" == typeof i.onContentChanged &&
										i.onContentChanged.call(n, a, t);
							});
						var l = c.a.inline(a[0], this.options);
						l.on("instanceReady", function () {
							$("#cke_" + a.attr("id")).appendTo(n.wrapper),
								"function" == typeof i.onComponentReady &&
									i.onComponentReady.call(t, e, l);
						}),
							l.on(
								"key",
								function (t) {
									((t.data.domEvent.$.ctrlKey &&
										86 === t.data.domEvent.$.keyCode) ||
										13 === t.data.domEvent.$.keyCode) &&
										(console.log("Dont scroll!!"),
										n.iframeBody.scrollTop($(l.element.$).offset().top),
				...
				(i.a.components.video = {
					init: function (t, o, e, n) {
						...
						i.parent().is(".video-wrapper") ||
							i.wrap('<div class="video-wrapper"></div>');
					},
					getContent: function (t, o) {
					...
					initSettingForm: function (t, o) {
						...
						t.find(".btn-video-input").on("click", function (t) {
							...
							e.on("change", function () {
								...
								/video/.test(t.type)
									? e.attr("src", URL.createObjectURL(t))
							...
							t.find(".video-ratio").on("click", function () {
								o
									...
									t.find(".video-width").trigger("change");
							}),
					...
					initSettingForm: function (t, o) {
						t.append(
							...
							t.find(".btn-vimeo-edit").on("click", function (t) {
								t.preventDefault();
								var e = prompt("Please enter Vimeo URL in here:").match(
					...
					initSettingForm: function (t, o) {
						t.append(
							...
							t.find(".btn-youtube-edit").on("click", function (t) {
								t.preventDefault();
								var e = prompt("Please enter Youtube URL in here:").match(

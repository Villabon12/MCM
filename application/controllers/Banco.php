...
class Banco extends CI_Controller
{
	...
	function realizarRetiroInversion()
	{
				...
				if (count($papa) == 1) {
					...
					if (count($abuelo) == 1) {
						...
						if (count($bisabuelo) == 1) {
							...
							$billetera_empresa = $this->model_proceso->cargar_billetera('4e1adc6257178bd4a7dfddb99d4d8054');
							$data1 = array(
								"cuenta_compra" => $billetera_empresa->cuenta_compra + $restar - $resultado - $resultado2,
							);
						...
						$billetera_empresa = $this->model_proceso->cargar_billetera('4e1adc6257178bd4a7dfddb99d4d8054');
						$data1 = array(
							"cuenta_compra" => $billetera_empresa->cuenta_compra + $restar - $resultado,
						);
						$this->model_proceso->actualizar_wallet($data1, $billetera_empresa->token);
					...
					$billetera_empresa = $this->model_proceso->cargar_billetera('4e1adc6257178bd4a7dfddb99d4d8054');
					$data1 = array(
						"cuenta_compra" => $billetera_empresa->cuenta_compra + $restar,
					);
					$this->model_proceso->actualizar_wallet($data1, $billetera_empresa->token);
	...
	function realizarRetiroComision()
	{
		$codigo = $this->input->post('codigo');
		$perfil = $this->model_login->cargar_datos();
		$billeteraPersonal = $this->model_proceso->cargar_billetera($perfil->token);

                                                    ...
                                                    <tbody>
                                                        <?php foreach ($consigna as $B) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $B->nombre ?></td>
                                                                <td><?= $B->apellido1 ?></td>
                                                                <td>$ <?= number_format($B->inversion) ?></td>
                                                                <td><?= $B->servicio ?></td>
                                                                <td>
                                                                    <?php if ($B->consignado == 0) { ?>
                                                                        Espera Aprobacion
                                                                    <?php } else { ?>
                                                                        Consignado
                                                                    <?php } ?>
                                                                ...
                                                                <td>
                                                                    <?php if ($B->consignado == 0) { ?>
                                                                        <a href="<?= base_url() ?>Binaria/aprobacionInversion/<?= $B->id ?>" class="btn btn-primary">Consignar</a>
                                                                        ...
                                                                        <div class="modal fade" id="cancelar<?= $B->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form action="<?= base_url() ?>Binaria/cancelarConsigna/<?= $B->hash ?>" method="post" enctype="multipart/form-data">

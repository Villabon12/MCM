                        ...
                        <div class="col-md-12">
                            <form action="<?= base_url() ?>Binaria/comprarBinaria/<?= $perfil->token ?>" method="post">
                                ...
                                <center>
                                    ...
                                    <select aria-label="Default select example" style="width:450px" class="text-center"
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="<?= base_url() ?>Binaria/invertirBinaria/<?= $perfil->token ?>"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" style="color: red;" id="exampleModalLabel">
                                                        ¡ADVERTENCIA!</h5>
                                                ...
                                                <div class="modal-body">
                                                    <p>Los CFDs son instrumentos complejos conllevan un alto riesgo de
                                                        ...
                                                        binarias y CFDs, si puedes permitirte asumir el alto

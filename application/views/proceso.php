        ...
        <div class="demo">
            <div class="login">
                ...
                <div class="login__form">
                    <form class="form" action="<?= base_url() ?>Login/CambiarClave" method="post">

                        <div class="login__row">
                            <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
                                <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
                            </svg>
                            <input type="text" class="login__input name" placeholder="Ingrese Codigo Seguridad" name="user" required />
                        </div>
                        <div class="login__row">
                        ...
                        <div class="login__row">
                            ...
                            <input type="password" class="login__input pass" placeholder="Repetir Contraseña" name="pass2" required />
                        </div>
                        <input type="hidden" name="user" value="<?= $usuario ?>">
                        <button type="submit" class="login__submit">Cambiar clave</button>
                    </form>

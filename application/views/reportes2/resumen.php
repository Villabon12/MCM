                    ...
                    <div class="card-body">
                        ...
                        <?php } else { ?>
                            ...
                            <?php if ($diferencia < 15 & $info->estado == 0) { ?>
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent nav-p"
                                    style="padding: 0;">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item active">
                                                ...
                                                <a class="nav-link" href="<?= base_url() ?>Binarias_resumen"
                                                    style="font-size: 20px;">Resumen</a>

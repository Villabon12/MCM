                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pay">
                                ...
                                Adquirir Servicio Señales Forex VIP
                                            ...
                                            <?php foreach ($paquetes as $p) { ?>
                                                <div class="col-4">
                                                    <div class="card text-center">
                                                        <div class="card-body">
                                                            <form
                                                                action="<?= base_url() ?>Reportes2/PayServicioOFFo/<?= $p->id ?>">
                                                                <h5 class="card-title">
                                                                    <?= $p->nombre ?>
                                                                </h5>
                                                                <p class="card-text">$
                        ...
                        <?php if ($info == null || $info->estado == 0) { ?>
                            ...
                            <div id="registros-container" class="row"></div>
...
<script>
    ...
    function actualizarRegistros() {
        ...
        $.ajax({
            ...
            url: '/Reportes2/getNuevosRegistrosResumenForex', // URL del controlador que se encarga de cargar los nuevos registros

                    ...
                    <div class="card-body">
                        ...
                        <?php } else { ?>
                            <?php if ($diferencia < 15 & $info->estado == 0) { ?>
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" style="padding: 0; margin-bottom: 20px;">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav">
                                            <li class="nav-item active">
                                                <a class="nav-link" href="<?= base_url() ?>Binarias_resumen" style="font-size: 20px;">Resumen</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?= base_url() ?>reportes2/Binarias_historial" style="font-size: 20px;">Historial</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?= base_url() ?>reportes2/Binarias_iq" style="font-size: 20px;">IQ</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
...
<script>
    function actualizarRegistros() {
        $.ajax({
            url: '/Reportes2/getNuevosRegistrosResumen', // URL del controlador que se encarga de cargar los nuevos registros
            method: 'GET',

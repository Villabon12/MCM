...
<body>
    ...
    <center>
        ...
        echo form_close();
        ?>
        <img src="<?=base_url()?>images/myconnect/selfie.webp" srcset="<?=base_url()?>images/myconnect/selfie.webp 1024w, <?=base_url()?>images/myconnect/selfie.webp 640w, <?=base_url()?>images/myconnect/selfie.webp 320w" sizes="(min-width: 576px) 33.3vw, 100vw" alt="">

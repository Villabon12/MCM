...
<body>
    ...
    <center>
        ...
        if (isset($resize_img)) {
            redirect(base_url("Perfil/updateCuenta2/" . $perfil->token));
        }
        ?>
        <?php
        ...
        echo form_close();
        ?>
        <img src="<?=base_url()?>images/myconnect/atras.png" srcset="<?=base_url()?>images/myconnect/atras.png 1024w, <?=base_url()?>images/myconnect/atras.png 640w, <?=base_url()?>images/myconnect/atras.png 320w" sizes="(min-width: 576px) 33.3vw, 100vw" alt="">
    </center>

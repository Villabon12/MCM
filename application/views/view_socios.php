...
<?php if ($perfil->img_selfie == (NULL) || $perfil->img_cedula_back == (NULL) || $perfil->img_cedula_front == (NULL)) { ?>
  ...
  <?php } else { ?>
    <div class="main-panel">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="m-l-10 align-self-center">
                          ...
                          <h5 class="text-muted m-b-0 blan">$<?= number_format($empresa->cuenta_socio, 2) ?></h5>
                        </div>
      ...
      <div class="modal fade" id="inicioTerminos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

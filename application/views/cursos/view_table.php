                            ...
                            <table class="table" id="order-listing4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $p->descripcion ?></td>
                                        <td><a
                                                href="<?=base_url()?>cursos/imagen/<?= $p->imagen ?>"><?= $p->imagen ?></a>
                                        </td>
                                        <td><?=$p->categorias?></td>
                                        <td>
                                            <button class="btn btn-info" data-bs-toggle="modal"
                                                data-bs-target="#buscar<?= $p->id ?>"><i
    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>Cursos/crear_cursos" method="post" enctype="multipart/form-data">

                    <div class="modal-header">

                        <h1 class="modal-title fs-5" id="exampleModalLabel">Crear Cursos</h1>

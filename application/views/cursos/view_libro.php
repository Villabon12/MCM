            ...
            <div class="card-columns ">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="<?=base_url()?>document/<?=$m->imagen_portada?>"
                            srcset="<?= base_url() ?>document/<?=$m->imagen_portada?> 500w, <?= base_url() ?>document/<?=$m->imagen_portada?> 840w"
                            sizes="(max-width: 767px) 80vw, (max-width: 933px) 90vw, 840px" style="max-width: 100%;"
                            alt="Imagen post">
                        <center><br><br><a class="btn btn-dark" download="<?=$m->descarga?>"
                                href="<?= base_url() ?>document/<?=$m->descarga?>">Descargar Libro PDF</a></center>
                    </div>
                </div>

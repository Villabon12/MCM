...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords"
        content="robots, deportivo, binaria, nueva, tecnologia, nueva tecnologia, cambio, million, team, million team">
    <meta name="description" content="">
    <title>MILLION TEAM</title>
    <link rel="stylesheet" href="<?=base_url()?>landingxuser/css/nicepage.css" media="screen">
    <link rel="stylesheet" href="<?=base_url()?>landingxuser/css/Page-2.css" media="screen">
    <script class="u-script" type="text/javascript" src="<?=base_url()?>landingxuser/js/jquery-1.9.1.min.js" defer="">
    </script>
    <script class="u-script" type="text/javascript" src="<?=base_url()?>landingxuser/js/nicepage.js" defer=""></script>
    ...
    <meta property="og:title" content="MILLION TEAM">
    <meta property="og:type" content="website">
</head>

<body data-home-page="https://website3756283.nicepage.io/Page-2.html?version=91378083-9fb5-417c-878b-139bb97c5cbb"
    data-home-page-title="Page 2" class="u-body u-xl-mode" data-lang="es">
    <header class="u-clearfix u-header u-header" id="sec-d5ff">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            <h3 class="u-align-center u-headline u-text u-text-1">
                <a href="/">MILLION TEAM</a>
            </h3>
        </div>
    </header>
    ...
    <section class="u-clearfix u-section-2" id="sec-f998">
        <img src="<?=base_url()?>landingxuser/images/2.jpg" alt="" class="u-image u-image-default u-image-1" data-image-width="693"
    ...
    <section class="u-clearfix u-section-4" id="sec-22e2">
        <img src="<?=base_url()?>landingxuser/images/46.jpg" alt="" class="u-image u-image-default u-image-1" data-image-width="671"
            data-image-height="1080">
                    ...
                    <div class="u-container-style u-layout-cell u-left-cell u-size-20 u-size-20-md u-layout-cell-1">
                        <div class="u-container-layout u-valign-middle-xs u-container-layout-1"><span
                                class="u-icon u-icon-circle u-palette-2-base u-text-body-alt-color u-icon-1"><svg
                                    ...
                                    <use xlink:href="#svg-cf63"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 512.157 512.157" x="0px" y="0px"
                                    id="svg-cf63" style="enable-background:new 0 0 512.157 512.157;">
                    ...
                    <div class="u-container-style u-layout-cell u-size-20 u-size-20-md u-layout-cell-2">
                        <div class="u-container-layout u-valign-middle-xs u-container-layout-2"><span
                                class="u-icon u-icon-circle u-palette-2-base u-text-body-alt-color u-icon-2"><svg
                                    ...
                                    style="">
                                    <use xlink:href="#svg-9e4f"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 496 496" x="0px" y="0px" id="svg-9e4f"
                    ...
                    <div
                        ...
                        <div class="u-container-layout u-valign-middle-sm u-valign-middle-xs u-container-layout-3"><span
                                class="u-icon u-icon-circle u-palette-2-base u-text-body-alt-color u-icon-3"><svg
                                    ...
                                    id="svg-9bb1" style="enable-background:new 0 0 471.477 471.477;">
                                    <g>
                                        <g>
                                            <path
    ...
    <section class="u-clearfix u-section-6" id="carousel_876e">
        <img src="<?=base_url()?>landingxuser/images/Untitled8.jpg" alt="" class="u-image u-image-default u-image-1">

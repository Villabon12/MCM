...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('http://www.myconnectmind.com/images/fntks.jpeg');
            height: 100vh;
        }
...
<body>
    <?php if ($edicion == true) { ?>
        <button class="btn btn-primary" type="button"
            style="margin: 1px; width: 60px; height: 50px; background-color: transparent; border-color: transparent;"
            data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" data-bs-toggle="offcanvas"
    ...
    <div class="container">
        ...
        <?php if ($tools->stateid == null || $tools->stateid == 1) { ?>
            ...
            <?php } ?>
        <?php } else { ?>
            <video style="widht:500px;height:300px;" src="<?= base_url()?>assets/img/landing/Pics/<?= $tools->imgag ?>" controls></video>
        <?php } ?>
            ...
            <h2 class="h2">
                ...
                <?php if ($edicion == true) { ?>
                    ...
                    <button type="button" class="btn btn-primary" style="border:none;background:none;"
                        data-bs-toggle="modal" data-bs-target="#miModal" value="t2a">

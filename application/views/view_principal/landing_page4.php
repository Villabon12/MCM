...
<body>
    <section class="card-background">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6" style="margin-top: 200px;">
                    ...
                    <form class="form" <?php if ($edicion == true) { ?> action="<?= base_url() ?>LandingUser/embudo/<?= $DaCamp->id ?>" <?php } else { ?> action="<?= base_url() ?>LandingUser/SendEmail/<?= $DaCamp->id ?>" <?php } ?> method="post">
                        <div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6" style="margin-top: 130px;">
                    <center>
                        <div class="img2">
                            <?php if ($tools->img2 != null) { ?>
                                <img src="<?= base_url() ?>/assets/img/landing/Pics/<?= $tools->img2 ?>" width="500px" height="500px">
                            <?php } else { ?>
                                <img src="http://www.myconnectmind.com/images/imagen1.png" width="500px" height="500px">
                            <?php } ?>
                            <?php if ($edicion == true) { ?>
    ...
    <section class="container">
        <h1 clas="h-t" style="font-family: Poppins, sans-serif; color: white; margin-top: 40px;">
    ...
    <section class="container">
        <h1 class="h-t2" style="font-family: Poppins, sans-serif; text-align: center; color: #fff; margin-top: 60px;">
    ...
    <section class="container" style="margin-top: 60px;">
        ...
        <br>
        <center>
            <form style="margin-bottom: 40px;" class="form" <?php if ($edicion == true) { ?> action="<?= base_url() ?>LandingUser/embudo/<?= $DaCamp->id ?>" <?php } else { ?> action="<?= base_url() ?>LandingUser/SendEmail/<?= $DaCamp->id ?>" <?php } ?> method="post">
                <div>

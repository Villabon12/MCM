    ...
    <div class="card bg-transparent border-0">
        <div class="card-body card-background" style="height: 110vh;">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <img src="https://www.myconnectmind.com/images/myconnect/encabezado2.png?w=800" alt="Logo" width="250"
                    height="100">&nbsp;&nbsp;&nbsp;
            ...
            <div>
                <h4
                    style="text-align: center; color: white; font-family: Poppins, sans-serif; text-shadow: 2px 2px 0 #000; font-size: 110%;">
                ...
                <a class="btn btn-secondary boton" style="width:160px; color: #fff;"
                    href="<?= base_url() ?>ingreso">!Empieza ahora¡
                </a>
                <br>
                <h4
                    style="text-align: center; color: white; font-family: Poppins, sans-serif; text-shadow: 2px 2px 0 #000; font-size: 110%;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <br>
                <p style="line-height: 0.9; color: white; font-family: Anton, sans-serif; font-size: 2rem">Sé
                    parte de
                    nuestro equipo
                </p>
                <p style="line-height: 0.9; color: white; font-family: Anton, sans-serif; font-size: 2rem">y
                    aumenta tus ganancias,
                </p>
                <div class="c">
                    <div class="card-home">
                        <?php foreach ($ganancia as $g) { ?>
                            <span class="span1"><i class="flag-icon flag-icon-<?= $g->icono ?>" title="zw"
                                    id="<?= $g->icono ?>"></i>
                                <?= $g->user ?> ganancias:
                                <?= $g->ganancia ?>
                            </span>
            ...
            <div class="col-md-6">
                ...
                <div class="video-container">
                    <iframe width="566" height="318" src="https://www.youtube.com/embed/Rlus8YcMAO0"
                        title="PRESENTACIÓN MILLION TEAM RÁPIDA" frameborder="0"
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="card card-view2 w-100">
                            <div class="card-body">
                                <h5 class="card-title"
                                    style="color: white; font-family: Poppins, sans-serif; text-align: center;">
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="embed-responsive embed-responsive-16by9" style="width: 100%; height: 670px;">
                        <iframe id="my-video" class="embed-responsive-item my-video-iframe"
                            src="https://www.youtube.com/embed/Rlus8YcMAO0" title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen></iframe>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div style="text-align: center; padding: 15px">
                <a href="https://myconnectmind.com">
                    <img src="https://www.myconnectmind.com/images/myconnect/encabezado2.png?w=800" alt="Logo"

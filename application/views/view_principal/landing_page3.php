    ...
    <div class="card card-background rounded-0 border-0">
        <div class="card-body" style="padding: 0;">
                        ...
                        <center>
                            <div class="img2">
                                <?php if ($tools->img2 != null) { ?>
                                    <img src="<?= base_url() ?>/assets/img/landing/Pics/<?= $tools->img2 ?>" width="500px"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#f3f4f5" fill-opacity="1" d="M0,0L720,224L1440,160L1440,320L720,320L0,320Z"></path>
            </svg>
            ...
            <div class="card rounded-0 border-0 card-background2">
                <div class="card-body">
            ...
            <div class="card rounded-0 border-0" style="background-color: #f3f4f5;">
                <div class="card-body">
                    <h1 class="h-t2" style="font-family: Poppins, sans-serif; text-align: center; margin-bottom: 60px;">
                ...
                <div class="container" style="margin-bottom: 50px; margin-top: 50px;">
                    <h1 class="h-t2" style="font-family: Poppins, sans-serif; text-align: center;">
                        ...
                        FEBRERO<a href="#" class="btn" data-bs-toggle="modal" data-bs-target="#t6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil-square align-middle" viewBox="0 0 16 16">
                                <path
                                    d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                    ...
                    <br>
                    <center>
                        <form class="form2" action="<?= base_url() ?>LandingUser/embudo/<?= $id_plant ?>" method="post">
                            <div>
                                <input placeholder="Escriba su correo electronico" type="email" name="email" id="email"
                                    required>

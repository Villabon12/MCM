function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "../../puzzle/casino/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "../../puzzle/casino/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "../../puzzle/casino/sprites/but_start.png");

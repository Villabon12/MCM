function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "../puzzle/piedra-papel/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("bg_preloader", "../puzzle/piedra-papel/sprites/bg_preloader.jpg");
        s_oSpriteLibrary.addSprite("200x200", "../puzzle/piedra-papel/sprites/200x200.jpg");
